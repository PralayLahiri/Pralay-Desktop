var Helper = {
    ...
    multiselectOption: {
        ...
        setValues: (function (identity, commaSeperatedValues) {
            ...
            $(identity).parent().find('.dropdown-menu li input[type="checkbox"]:checked').trigger('click');

            var v = commaSeperatedValues.split(',');
            for (var i = 0; i < v.length; i++) {
                var chechBox = $(identity).parent().find('.dropdown-menu li input[type="checkbox"][value="' + v[i] + '"]');
